...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ $setting->favicon ?? asset('assets/images/default-male.png') }}"
        sizes="16x16">
    <!-- remix icon font css  -->
                    ...
                    <span class="d-flex align-items-start gap-10">
                        <img src="{{ auth()->user()->image
                            ...
                            : (auth()->user()->gender == 'female'
                                ? asset('assets/images/default-female.png')
                                : asset('assets/images/default-male.png')) }}"
