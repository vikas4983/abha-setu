    ...
    ** Header **
    ...
    <header>
        ...
        <div class="container header-middle">
            <div class="row"> <span class="col-xs-6 col-sm-3"><a href="index.html"><img src="{{asset('assets-frontend/images/logo.png')}}" class="img-responsive" alt=""></a></span>
    ...
    <footer class="footer">
        ...
        <div class="container">
            <div class="row row1">
                ...
                <div class="col-sm-3">
                    <div class="footer-logo hidden-xs"><a href="index.html"><img src="{{asset('assets-frontend/')}}images/footer-logo.png" class="img-responsive" alt=""></a></div>
