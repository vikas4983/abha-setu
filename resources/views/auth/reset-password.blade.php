        ...
        <div class="lg-w-50 px-24 py-32 d-flex justify-content-center align-items-center">
            <div class="max-w-540-px mx-auto">
                ...
                <form action="{{ route('password.update') }}" method="POST"
                    ...
                    <div class="d-flex flex-column gap-16">
                        <div>
                            ...
                            <input type="email" id="email" name="email"
                                value="{{ old('email', $request->email ?? '') }}" class="email-field form-control"
                        ...
                        <div>
                            ...
                            <div class="position-relative">
                                <input type="password" id="password" name="password"
                                    class="password-field form-control" placeholder="Enter password" required>
                                <button type="button"
                        ...
                        <div>
                            ...
                            <div class="position-relative">
                                <input type="password" id="password_confirmation" name="password_confirmation"
                                    class="password-field form-control" placeholder="Enter confirmation password "
                                    required>
                                <button type="button"
                                    class="toggle-password btn p-0 border-0 bg-transparent position-absolute end-0 top-50 translate-middle-y me-16 text-secondary-light cursor-pointer ri-eye-line"
                    ...
                    <div class="">
                        <button type="submit"
                            class="loginBtn btn btn-primary-600 text-sm btn-sm px-12 py-16 w-100 radius-8"> Change
                            Password
                        </button>
                    </div>
