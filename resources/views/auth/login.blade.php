            ...
            <div class="max-w-540-px mx-auto">
                ...
                <form action="{{ route('login') }}" method="POST" class="d-flex flex-column gap-32 submit-form">
                    ...
                    <div class="d-flex justify-content-between gap-2">
                        <a href="#" class="text-primary-600 fw-medium text-decoration-underline">Forgot
                            Password?</a>
                    </div>
                    <div class="">
                        <button type="submit"
                ...
                <div class="mt-32 text-center text-sm">
                    ...
                    <a href="{{ route('register') }}" class="text-primary-600 fw-semibold text-decoration-underline">
                        Create an account
                    </a>
                </div>
            </div>
